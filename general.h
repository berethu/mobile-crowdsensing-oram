...
#ifndef benesFunction
  // Define your favourite benesFunction options here
  // #define benesFunction __attribute__((fastcall))
  // #define benesFunction __attribute__((regparm(3)))
  #define benesFunction
#endif
...
benesFunction t_int random_int(t_int x);
benesFunction t_bool init_general();
