...
{
	std::fstream file;
	file.open(filename, std::fstream::in | std::ios::app | std::ios::binary);	
...
{
	std::fstream file;
	// file.open(filename, std::ios::out | std::ios::trunc | std::ios::binary); Emmanuel
	file.open(filename, std::ios::out | std::ios::ate | std::ios::app | std::ios::binary);
